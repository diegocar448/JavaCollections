package onedigitalinnovation.comparators;
...
public class ComparatorsExampleList {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--- ordem natuaral dos numeros - idade (method Comparable) ---");
        System.out.println(estudantes);

        Collections.sort(estudantes, new EstudanteOrdemIdadeReversaComparator());

        System.out.println("--- ordem reversa dos numeros - idade (method Comparator) ---");
        System.out.println(estudantes);
    }
}
